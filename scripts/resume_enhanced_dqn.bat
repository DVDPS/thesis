@echo off
REM Batch file to resume the Enhanced Dueling DQN training with increased parameters
...
REM Default values for resuming
set EPISODES=12200
set BATCH_SIZE=8192
set LEARNING_RATE=0.00001
set RESUME_FROM=models\enhanced_dqn\enhanced_dqn_per_3000.pt
...
set UPDATE_FREQ=4
set SAVE_FREQ=500
set CHECKPOINT_DIR=models\enhanced_dqn_v2
