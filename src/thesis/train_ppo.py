...
def train_ppo(args):
    """
    Train a PPO agent on the 2048 game.
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Train PPO agent for 2048 game (H100 optimized)")
    ...
    parser.add_argument("--output-dir", type=str, default="ppo_results", help="Output directory")
